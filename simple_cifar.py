...
def train(model, train_inputs, train_labels, time_limit):
    ...
    while total_time_seconds < time_limit:
        ...
        with torch.no_grad():
            ...
            # print(f"{results[-1][0]:<10.2f}{results[-1][1]:<15.4f}{results[-1][2]:<15.4f}{results[-1][3]:<10.2f}")
            print(f"{results[-1][0]:10.2f}{results[-1][1]:15.4f}{results[-1][2]:15.2f}{results[-1][3]:10.2f}")
